...
RUN mvn -f /cinema_base/pom.xml clean package -Dmaven.test.skip -Dcheckstyle.skip
...
EXPOSE 5557
ENTRYPOINT ["java","-Dspring.profiles.active=dev","-jar","/usr/local/lib/cinema_base.jar"]